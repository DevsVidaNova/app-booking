    ...
    <div className="flex flex-col container w-full px-3 py-4">
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground max-w-md">Não foi possível carregar os usuários. Verifique sua conexão e tente novamente.</p>
        </div>
        ...
        <Card className="p-6 max-w-md w-full">
          <div className="text-center space-y-4">
            ...
            <h4 className="text-lg font-medium">Gerenciamento de Usuários</h4>
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>• Visualize todos os usuários cadastrados</p>
              <p>• Edite informações dos usuários</p>
              <p>• Reset de senhas quando necessário</p>
              <p>• Exclua usuários do sistema</p>
            </div>
          </div>
        </Card>
