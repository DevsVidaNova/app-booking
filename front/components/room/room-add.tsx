...
import { Drawer, Message, DrawerClose, DrawerContent, DrawerDescription, DrawerFooter, DrawerHeader, DrawerTitle, DrawerTrigger, Input, Form, FormControl, FormField, FormItem, FormLabel, FormMessage, Button } from "@/components/ui/";
...
export function RoomAddForm() {
  const [open, setOpen] = useState(false);
  const createMutation = RoomsService.useCreate();
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <DrawerFooter className="border-t-2 pt-[16px]">
                  <div className="flex flex-col w-full gap-4">
                    <Button type="submit" disabled={createMutation.isPending} className="text-[18px] font-semibold py-6 rounded-full w-full">
