        ...
        <div className="flex flex-row justify-between items-center">
          <DrawerTrigger>
            <div className="flex flex-row ">
              <div className="uppercase w-[52px] h-[52px] bg-secondary rounded-full items-center justify-center flex flex-col">{user?.name?.slice(0, 2)}</div>
              <div className="flex flex-col pl-3 justify-center items-start">
                <span className="font-semibold text-[18px] -mb-1">{user?.name}</span>
                <span className="font-regular text-[14px] opacity-70">{user?.email}</span>
              </div>
            </div>
          </DrawerTrigger>
