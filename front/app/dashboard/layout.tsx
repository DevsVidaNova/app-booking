...
export default function DashLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="bg-background w-full flex ">
          ...
          <Drawer>
            <div className="container justify-between items-center flex-row flex">
              <Link href="/" className="flex flex-col ">
                <Image alt="logo black" src="/imgs/logo_black.png" width={220} height={60} className="w-[220px] h-[60px] bg-gray self-center items-center -ml-8 " />
              </Link>
      ...
      <div className="container mx-auto flex pt-[90px]">{children}</div>
    </div>
  );
}
